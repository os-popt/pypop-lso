...
class Experiment(object):
    ...
    def __init__(self, params):
        ...
        self.policy, self.separators, self.ndim_problem =\
            _get_policy(self.env_ndim_observation, self.env_ndim_actions)
        ...
        self.data_dir = "./env_{}_opt_{}".format(self.env_name, self.optimizer.__name__)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--datafile_suffix', '-ds', type=str, default="")
