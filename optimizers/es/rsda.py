...
class RestartSDA(MuCommaLambda):
    """Restart-based Search Direction Adaptation Evolution Strategy (R-SDA-ES) for large-scale, black-box optimization.
    ...
    https://github.com/hxyokokok/SDAES    (note that it does not include the restart option)
    """
    def __init__(self, problem, options):
        options.setdefault("optimizer_name", "RestartSDA (R-SDA-ES)")
